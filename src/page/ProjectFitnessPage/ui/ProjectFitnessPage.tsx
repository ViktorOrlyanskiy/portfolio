                ...
                <div className={cls.wrapper}>
                    <RowBlock
                        ...
                        firstColumn={
                            <div className={cls.columnLeftText}>
                                <TitleBlock
                                    title="Выбирай упражения"
                                    subtitles={[
                                        "Базовые упражения уже занесены, осталось выбрать нужное. Также всегда можно добавить свое упражение.",
                                    ]}
                                />
                                <LinkDown
                ...
                <div className={cls.wrapper}>
                    <RowBlock
                        ...
                        firstColumn={
                            <div className={cls.columnLeftText}>
                                <TitleBlock
                                    title="Смотри результаты"
                                    subtitles={[
                                        "Статистика ведется по каждому упражению. Ты всегда будешь в курсе своих результатов.",
                                    ]}
                                />
                                <LinkDown
                ...
                <div className={cls.wrapper}>
                    ...
                    <div className={cls.description}>
                        <div>
                            ...
                            качестве хранилища используется Redux Toolkit. Чтобы
                            код оставался чистым старался максимально
                        ...
                        <br />
                        <div>
                            Приложение не адаптировано под декстоп, так как нет
                            в этом необходимости. На ПК лучше смотреть через
                            панель разработчика, на экране Iphone SE.
                            <br />
                            <br />
                            Ссылка для мобильного телефона:
                        ...
                        <div>
                            ...
                            <span>test@test.ru / test123</span>
                        </div>
                    </div>
                </div>
            </section>
